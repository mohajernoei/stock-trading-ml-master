...
ohlcv_histories, technical_indicators, next_day_open_values, unscaled_y, y_normaliser = csv_to_dataset('EURUSD60.csv')
...
for ohlcv, ind in zip(ohlcv_test[start: end], tech_ind_test[start: end]):
    ...
    if predicted_price_tomorrow > predicted_price_tomorrow1:
        buys.append((x, price_today[0][0]))
    elif predicted_price_tomorrow < predicted_price_tomorrow1:
